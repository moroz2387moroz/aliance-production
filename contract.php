  ...
  <body>
    <div class="mobile-menu">
      <ul class="mobile-menu-nav">
        ...
        <li class="mobile-menu-item">
          <a href="/contractual.php" class="mobile-menu-link">Контрактное производство</a>
    ...
    <nav class="navbar navbar-light">
      ...
      <ul class="header-nav">
        ...
        <li class="header-nav-item">
          <a href="/contractual.php" class="header-nav-link">Контрактное производство</a>
        </li>
        <li class="header-nav-item">
    ...
    <header class="header">
      <div class="header-bg">
        ...
        <div class="header-content header-l-content">
          ...
          <h1 class="header-title header-l-title">Контрактное производство</h1>
          <div class="breadcrumbs">
            <a href="index.php" class="breadcrumb-link">Главная</a>
            <span class="breadcrumb-separator">&mdash;</span>
            <span class="breadcrumb-text">Контрактное производство</span>
          </div>
        </div></div>
      </div>
    </header>
